  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full pointer-events-none z-[9999] overflow-hidden">
      ...
      <div
        ...
        className="absolute -left-[13%] lg:left-[5%] -top-[7%] rotate-[15deg] scale-100 lg:scale-200"
      >
        <FlowerLeft1 />
      </div>
      ...
      <div
        ...
        className="absolute left-[-20%] lg:left-[0%] top-[6%] -rotate-[25deg] scale-100 lg:scale-200"
      >
        <PetalosLeft1 />
      </div>
      ...
      <div
        ...
        className="absolute left-[20px] lg:left-[60px] -top-[180px] rotate-[45deg] scale-100 lg:scale-200"
      >
        <FlowerLeft2 />
      </div>
      ...
      <div
        ...
        className="absolute -left-[10%] lg:left-[8%] -top-[10%] -rotate-[35deg] scale-100 lg:scale-200"
      >
        <FlowerLeft3 />
      </div>
      ...
      <div
        data-flower="flower-left-3"
        className="absolute right-[10%] -top-[100px] -rotate-[35deg] scale-100 lg:scale-200"
      >
        <FlowerRight1 />
      </div>
      ...
      <div
        ...
        className="absolute -right-[10%] -top-[8%] -rotate-[10deg] scale-100 lg:scale-200"
      >
        <PetalosRight1 />
      </div>
      ...
      <div
        ...
        className="absolute -right-[35px] top-[10px] scale-100 lg:scale-200"
      >
        <FlowerRight1 />
      </div>
      ...
      <div
        ...
        className="absolute left-[110%] top-[5%] -rotate-[20deg] scale-100 lg:scale-200"
      >
        <FlowerRight2 />
      </div>
      ...
      <div
        ...
        className="absolute left-[105%] top-[20%] rotate-[10deg] scale-100 lg:scale-200"
      >
        <FlowerRight3 />
      </div>
      ...
      <div
        data-flower="shine-1"
        className="absolute left-[8%] top-[15%] rotate-[45deg]"
      >
      ...
      <div
        data-flower="shine-2"
        className="absolute left-[88%] top-[12%] -rotate-[30deg]"
      >
      ...
      <div
        data-flower="shine-3"
        className="absolute left-[5%] top-[35%] rotate-[60deg]"
      >
      ...
      <div
        data-flower="shine-4"
        className="absolute left-[92%] top-[38%] -rotate-[45deg]"
      >
        <div className="scale-[0.4]">
          <Shine />
        </div>
      ...
      <div
        data-flower="shine-5"
        className="absolute left-[50%] top-[8%] rotate-[15deg]"
      >
        <div className="scale-[0.3]">
          <Shine />
        </div>
      ...
      <div
        data-flower="shine-6"
        className="absolute left-[48%] top-[85%] -rotate-[60deg]"
      >
        <div className="scale-[0.4]">
          <Shine />
        </div>
      ...
      <div
        data-flower="shine-7"
        className="absolute left-[12%] top-[55%] rotate-[75deg]"
      >
      ...
      <div
        data-flower="shine-8"
        className="absolute left-[85%] top-[62%] -rotate-[15deg]"
      >
      ...
      <div
        data-flower="shine-9"
        className="absolute left-[15%] top-[75%] rotate-[30deg]"
      >
        <div className="scale-[0.3]">
          <Shine />
        </div>
      ...
      <div
        ...
        className="absolute left-[82%] top-[78%] -rotate-[75deg]"
      >
        <div className="scale-[0.4]">
          <Shine />
        </div>
      ...
      <div
        ...
        className="absolute left-[25%] top-[25%] -rotate-[45deg]"
      >
        <div className="scale-[0.35]">
          <Shine />
        </div>
      ...
      <div
        ...
        className="absolute left-[75%] top-[28%] rotate-[45deg]"
      >
        <div className="scale-[0.3]">
          <Shine />
        </div>
